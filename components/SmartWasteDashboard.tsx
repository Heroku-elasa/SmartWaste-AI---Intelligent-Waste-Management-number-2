...
import { useLanguage, Page, WasteReport, WastePrediction, DashboardAnalytics, TuningHyperparameters, TuningLog } from '../types';
        ...
        return (
            <div className="p-8 bg-white rounded-lg animate-fade-in border border-gray-200 shadow-sm">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                     {/* Grant Card 1: CIFIA */}
                     <div className="bg-gradient-to-br from-gray-50 to-white p-6 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden group">
                        ...
                        <div className="relative z-10">
                            ...
                            <p className="text-sm text-gray-600 mb-4 h-10">{t('smartWasteDashboard.specialGrants.cifia.desc')}</p>
                     ...
                     <div className="bg-gradient-to-br from-gray-50 to-white p-6 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden group">
                        ...
                        <div className="relative z-10">
                            ...
                            <p className="text-sm text-gray-600 mb-4 h-10">{t('smartWasteDashboard.specialGrants.swifr.desc')}</p>
